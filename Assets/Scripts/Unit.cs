...
public class Unit : MonoBehaviour
{
	...
	[HideInInspector] public float HitPoints = 10;
	...
	{
		//if (sugoisugoi != null)
		//	GetComponent<AudioSource>().PlayOneShot(sugoisugoi);
		if (HitPoints <= 1 || HitPoints - amount < 1)
		{
			...
			Instantiate(Game.Victory_Cheer,transform.position, Quaternion.identity);
